...
CKPT_DIR  = ROOT / "checkpoints" / "06_pix2pix_lambda"
...
def main() -> None:
    ...
    print(
        ...
        f"batch_size={CONFIG['batch_size']} | lambda_l1={CONFIG['lambda_l1']} lambda_gan={CONFIG['lambda_gan']}",
        flush=True,
    )
    ...
    trainer = Pix2PixTrainer(
        ...
        wandb_run_name="06-pix2pix-lambda",
        wandb_config=CONFIG,
